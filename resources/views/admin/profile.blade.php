                                        ...
                                        <div class="card-body box-profile">
                                            <div class="text-center">
                                                @if ($user->image)
                                                    <img class="profile-user-img img-fluid img-circle"
                                                        src="{{ asset('storage/settings/profile/' . $user->image) }}"
                                            ...
                                            <ul class="list-group list-group-unbordered mb-3">
                                                ...
                                                <li class="list-group-item">
                                                    <form action="{{ route('admin.image.update', $user->id) }}"
                                                    ...
                                                    <form action="{{ route('users.update', $user->id) }}"
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="inputExperience"
                                                                class="col-sm-2 col-form-label">Your Bio</label>
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control" name="bio"
                                                                    placeholder="A short introduction about yourself eg.a Fullstack software engineer)">{{ $user->bio }}</textarea>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="password" class="form-control"
                                                                        value="" name="password"
                                                                        placeholder="Warning! changing this field will change your password">
                                                                </div>
                                                            </div>
